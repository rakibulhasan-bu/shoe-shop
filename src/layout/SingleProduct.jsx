...
const SingleProduct = ({ product }) => {
  const handleAddToCart = (product) => {
    axios
      .post("https://shoe-shop-bakend.vercel.app/api/cart", product)
      .then((response) => {
  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center ">
      <div className="max-w-md w-full bg-gray-200 rounded-xl p-6">
        <Link to={`/product-details/${1}`} className="">
          ...
          <div className="flex-auto justify-evenly">
            ...
            <div className="flex space-x-2 text-sm font-medium justify-start">
              <button
                ...
                className="transition ease-in duration-300 inline-flex items-center text-sm font-medium mb-2 md:mb-0 bg-orange-500 px-5 py-2 hover:shadow-lg tracking-wider text-white rounded-full hover:bg-orange-600 "
              >
                <span>Add Cart</span>
              </button>
            </div>
